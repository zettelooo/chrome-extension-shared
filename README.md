# Zettel: Shared between Web & Chrome Extension
...
```bash
$ npm install @zettelooo/chrome-extension-shared
```
...
```bash
$ git clone git@github.com:zettelooo/chrome-extension-shared.git
```

Install the dependencies:

```bash
$ cd chrome-extension-shared
$ npm install
```
